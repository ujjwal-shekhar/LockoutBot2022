...
class Handles(commands.Cog):
    ...
    def make_handle_embed(self, ctx):
        desc = "Information about Handle related commands! **[use lockout handle <command>]**\n\n"
    ...
    @commands.group(brief='Commands related to handles! Type lockout handle for more details', invoke_without_command=True)
